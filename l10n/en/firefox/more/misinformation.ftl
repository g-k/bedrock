...
misinformation-widespread-online = You can come across misinformation and disinformation everywhere but is most widespread and impactful when shared online. Algorithms and <a href="{ $tracking }">tracking</a> have increased the ability for misinformation and disinformation to reach a larger audience on websites, blogs, forums and social networks.
...
misinformation-surface-content-desc = When you open a new tab in your { -brand-name-firefox } browser, you’ll see articles <a href="{ $recommended }">recommended by { -brand-name-pocket }</a>. { -brand-name-pocket } doesn’t use any of your personal data to make recommendations. Instead, these articles are curated by real people based on content { -brand-name-pocket } users highlight as worth reading. The ability to discover new stories, angles, and opinions is one way to battle the spread of misinformation. To get even more recommendations, subscribe to the <a href="{ $pocket_hits }">{ -brand-name-pocket } newsletter</a> and download the <a href="{ $pocket }">{ -brand-name-pocket } app</a>.
